...
export const OPENAI_API_KEY = 'sk-example-key-replace-with-your-own'; // Kept for backward compatibility
export const GEMINI_API_KEY = 'AIzaSyB7RRqKHgGHD2AGPp2mht81ZTbeO--Nb2M'; // For Gemini API
...
export const AI_MODELS = {
  quizGenerator: "gemini-2.0-flash", // Using Gemini model
  teacherChat: "gemini-2.0-flash", // Using Gemini model
};
